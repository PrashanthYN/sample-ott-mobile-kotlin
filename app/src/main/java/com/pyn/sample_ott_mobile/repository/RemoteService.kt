...
class RemoteService {
    ...
    fun getUpcomingMovies(): Observable<ResponseContent> {
        val result=networkAPI.getUpComingMovies(1, StringConstants.languageUS, StringConstants.API_KEY)
        Log.d(TAG,result.toString())
        return result
    }

    fun getLatestMovies(): Observable<ResponseContent> {
        val result=networkAPI.getLatestMovies(1, StringConstants.languageUS, StringConstants.API_KEY)
        Log.d(TAG,result.toString())
        return result
    }

    fun getTopRatedMovies(): Observable<ResponseContent> {
        val result=networkAPI.getTopRatedMovies(1, StringConstants.languageUS, StringConstants.API_KEY)
        Log.d(TAG,result.toString())
        return result
    }

    fun getNowPlayingMovies(): Observable<ResponseContent> {
        val result=networkAPI.getNowPlayingMovies(1, StringConstants.languageUS, StringConstants.API_KEY)
        Log.d(TAG,result.toString())
        return result
    }
    ...
    fun getPopularTvShows(): Observable<ResponseContent> {
        val result=networkAPI.getPopularTvShows(1, StringConstants.languageUS, StringConstants.API_KEY)
        return result
    }

    fun getOnAirTvShows(): Observable<ResponseContent> {
        val result=networkAPI.getOnAirTvShows(1, StringConstants.languageUS, StringConstants.API_KEY)
        return result
    }

    fun getToRatedTvShows(): Observable<ResponseContent> {
        val result=networkAPI.getTopRatedTvShows(1, StringConstants.languageUS, StringConstants.API_KEY)
        return result
    }

    fun getAiringTodayTvShows(): Observable<ResponseContent> {
        val result=networkAPI.getAiringTodayTvShows(1, StringConstants.languageUS, StringConstants.API_KEY)
        return result
    }

    fun getLatestTvShows(): Observable<ResponseContent> {
        val result=networkAPI.getLatestTvShows(1, StringConstants.languageUS, StringConstants.API_KEY)
        return result
    }
